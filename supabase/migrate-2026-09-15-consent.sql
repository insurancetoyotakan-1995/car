...
-- =====================================================================
--  migrate 2026-09-15 (2) : ความยินยอม PDPA ท้ายฟอร์ม
--  ✅ ไฟล์นี้รวมของ migrate-2026-09-15-insured-info.sql ไว้แล้ว — รันไฟล์นี้ไฟล์เดียวพอ
--     (รันไฟล์ก่อนหน้าไปแล้วก็รันไฟล์นี้ซ้ำได้ ไม่เสียหาย)
--  - ins_submit ปฏิเสธใบที่ไม่ได้ติ๊กยินยอม · เก็บ consent_at (เวลาเซิร์ฟเวอร์) + consent_version
--  - ใบเก่าก่อนมีช่องยินยอม consent_at = null

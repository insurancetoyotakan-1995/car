-- =====================================================================
--  migrate 2026-09-15 (4) : คำนำหน้าชื่อผู้ทำประกัน
--  ✅ รวมของวันนี้ทั้งหมดแล้ว (5 ช่องข้อมูล + ความยินยอม PDPA + วันเกิด + คำนำหน้า)
...
alter table public.ins_requests add column if not exists insured_title   text not null default '';

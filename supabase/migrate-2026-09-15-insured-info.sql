...
-- =====================================================================
--  migrate 2026-09-15 : ข้อมูลผู้ทำประกันเพิ่ม 5 ช่อง (ขั้นที่ 2 ของฟอร์ม)
--  เลขบัตรประชาชน (ตรวจ checksum) · รหัสไปรษณีย์ · อาชีพ · ที่ทำงาน · รายได้ต่อเดือน
--  ⚠️ ลำดับ: push หน้าเว็บก่อน แล้วค่อยรันไฟล์นี้
--     (ไฟล์นี้บังคับกรอก 5 ช่อง — หน้าเว็บรุ่นเก่าที่ยังค้าง cache จะส่งไม่ผ่าน)
--  🔒 เลขบัตรประชาชนเป็นข้อมูลส่วนบุคคล: อ่านได้เฉพาะเจ้าหน้าที่ (RLS เดิม) · ไม่คืนกลับให้ฟอร์ม
